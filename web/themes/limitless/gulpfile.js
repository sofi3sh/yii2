...
if(direction == 'LTR') {
    gulp.task('sass', function() {
        return gulp
            ...
            .pipe(gulp.dest(layout + '/' + direction + '/' + theme + '/assets/css'))
...
gulp.task('js', function () {
    return gulp
        .src('global_assets/js/layouts/' + layout + '/' + theme + '/compile/**/*.js')
        .pipe(gulp.dest(layout + '/' + direction + '/' + theme + '/assets/js'))
        .pipe(sourcemaps.init())
        .pipe(uglify())
        .pipe(rename({
            suffix: '.min'
...
gulp.task('watch', function() {
    ...
    gulp.watch('global_assets/js/**/*.js', ['js']);
});
